...
import Abstracto from "../assets/images/robot-arm.svg"

const Hero = () => {
  return (
    <div className="bg-gray-900 text-white min-h-screen flex items-center justify-center px-6 py-12">
      {/* Container */}
      <div className="max-w-5xl py-10 mx-auto flex flex-col lg:flex-row items-center lg:space-x-12">
        ...
        <div className="text-center lg:text-left lg:flex-1">
          ...
          <p className="text-base md:text-lg mb-8">
            Abstracto helps developers streamline their environment setup with a powerful CLI for account abstraction and also help with creating wallet using social signin powered by Thirdweb. Choose between diamond or simple contracts, and build with Foundry.
          </p>
