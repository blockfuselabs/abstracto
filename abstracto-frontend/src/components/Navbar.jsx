    ...
    <header className="bg-gray-900 text-white w-full py-4 px-6 fixed top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <Link to="/open-source" className="hover:text-gray-400">Open Source</Link>
        </nav>
        ...
        <div className="hidden md:block">
          <Link
            to="/social-wallet"
            className="px-6 py-2 bg-[#BF64E7] text-black rounded-lg hover:opacity-75 transition-colors"
          >
            Launch CLI
          </Link>
        </div>
